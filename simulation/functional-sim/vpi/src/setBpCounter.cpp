...
int setBpCounter_calltf(char *user_data)
{
  unsigned char src;
  ...
  BPTAB[0]->set_counter(src,(unsigned int)current_value2.value.integer);
...
void setBpCounter_register() {
  s_vpi_systf_data task_data_s;

  task_data_s.type      = vpiSysTask;
  //task_data_s.sysfunctype = vpiSysFuncSized;
  task_data_s.tfname    = "$setBpCounter";
  task_data_s.calltf    = setBpCounter_calltf;
