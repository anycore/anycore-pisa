...
`define STRUCT_PARTS 2        // The number of partitions for reconfigurable structures
`define STRUCT_PARTS_LOG 1    
`define NUM_PARTS_RF 3        // The number of partitions for register file RAMs
`define NUM_PARTS_RF_LOG 2    
`define STRUCT_PARTS_LSQ 1        // The number of partitions for register file RAMs
